...
namespace RaLanguage.Interpreter.Values.Primitives
{
    public class ClassFieldReferenceValue : RuntimeValue
    {
        ...
        public ClassFieldReferenceValue(ClassInstanceValue instance, string fieldName)
        {
            Instance = instance;
            FieldName = fieldName;
        }
        ...
        {
            return new ClassFieldReferenceValue(Instance, FieldName)
                .SetContext(Context)
                .SetPos(PositionStart, PositionEnd);
        }

        public override string ToString() => $"&{Instance.Definition.ClassName}.{FieldName}={Value}";
